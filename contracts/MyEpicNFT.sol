...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["PALMEIRAS", "CORINTHIANS", "SAO PAULO", "REDBULL", "SANTOS", "BOTAFOGO", "VASCO", "FLAMENGO", "CRUZEIRO", "ATLETICO MINEIRO"];
  string[] secondWords = ["CAMPEAO", "BI-CAMPEAO", "TRI-CAMPEAO", "LANTERNA", "REBAIXADO", "ROUBOU", "JAMAIS GANHOU", "ATROPELOU", "SE PERDEU", "NUNCA CHEGARA A FINAL DA"];
  string[] thirdWords = ["LIBERTADORES", "BRASILEIRAO", "PAULISTINHA", "COPA DO BRASIL", "CHAMPIONS", "MUNDIAL", "SERIE B", "SOLTEIROS X CASADOS", "COPA DOS PIORES", "TORNEIO DE VERAO"];
